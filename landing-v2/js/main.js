(function () {
  ...
  if (!reduceMotion) {
    ...
    /* stagger children of grids/lists for a slightly more choreographed feel */
    [".feature-grid", ".bonus-grid", ".credential-list", ".steps", ".check-list"].forEach(function (sel) {
    ...
    gsap.set([".site-header", ".hero .eyebrow", ".hero__title", ".hero__text", ".hero__badges", ".hero__content .btn", ".hero__note"], { autoAlpha: 1, y: 0 });
